# GitHub Guidance Workflow
_Guidance and best practice rules for using GitHub with Admin and Health related data_
Built from previous amazing work of PHS John MacKintosh (@johnmackintosh)
